...
function HomeScreen({ navigate, subscription }: { navigate: (screen: Screen) => void; subscription: SubscriptionPayload }) {
  return <div className="page"><PageHeader title="Selamat siang, Pak Dito" subtitle="Berikut kondisi hatchery Anda hari ini." action={<button className="header-alert" onClick={() => navigate("alerts")}><Bell size={20} /><span>2</span></button>} />
